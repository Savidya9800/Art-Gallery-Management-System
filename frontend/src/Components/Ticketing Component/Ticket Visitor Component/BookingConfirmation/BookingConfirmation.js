...
function BookingConfirmation() {
  ...
  const { date, time, tickets, fname, lname, email, phone, city, country } = visitor;

  // Function to generate an ID with 'RES' + last 3 digits of an auto-generated value
  const generateId = () => {
    const autoGeneratedValue = Date.now(); // Or use Math.random() for a random number
